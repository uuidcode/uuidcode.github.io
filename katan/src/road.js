...
export const setHideRoad = (katanStore) => katanStore.update(katan => {
...
export const setRoadRippleDisabled = (katanStore) => katanStore.update(katan => {
    katan.roadList = katan.roadList
        .map(road => {
            road.ripple = false;
            return road;
...
export const clickMakeRoad = (katanStore, roadIndex) => katanStore.update(katan => {
    if (!katan.isMakeRoad) {
        return katan;
    }
...
export const setNewRoadRippleEnabled = (katanStore) => katanStore.update(katan => {
    katan.roadList = katan.roadList
        .map(road => {
...
export const makeRoad = (katanStore) => katanStore.update(katan => {
...
export const setRoadRippleEnabled = (katanStore, castleIndex) => katanStore.update(katan => {
    katan.isMakeRoad = true;
...
export const setRoad = (katanStore, roadIndex, playerIndex) => katanStore.update(katan => {
