...
katan.castleList[16].castleList = [17, 27];
katan.castleList[17].castleList = [7, 16, 18];
katan.castleList[18].castleList = [17, 19, 29];
katan.castleList[19].castleList = [9, 18, 20];
katan.castleList[20].castleList = [19, 21, 31];
katan.castleList[21].castleList = [11, 20, 22];
katan.castleList[22].castleList = [21, 23, 33];
katan.castleList[23].castleList = [13, 22, 24];
katan.castleList[24].castleList = [23, 25, 35];
katan.castleList[25].castleList = [15, 24, 26];
katan.castleList[26].castleList = [25, 37];

katan.castleList[27].castleList = [16, 28];
katan.castleList[28].castleList = [27, 29, 38];
katan.castleList[29].castleList = [18, 28, 30];
katan.castleList[30].castleList = [29, 31, 40];
katan.castleList[31].castleList = [20, 30, 30];
katan.castleList[32].castleList = [31, 33, 42];
katan.castleList[33].castleList = [22, 32, 34];
katan.castleList[34].castleList = [33, 35, 44];
katan.castleList[35].castleList = [24, 34, 36];
katan.castleList[36].castleList = [35, 37, 46];
katan.castleList[37].castleList = [26, 36];

katan.castleList[38].castleList = [28, 39];
katan.castleList[39].castleList = [38, 40, 47];
katan.castleList[40].castleList = [30, 39, 41];
katan.castleList[41].castleList = [40, 42, 49];
katan.castleList[42].castleList = [32, 41, 43];
katan.castleList[43].castleList = [42, 44, 51];
katan.castleList[44].castleList = [34, 43, 45];
katan.castleList[45].castleList = [44, 46, 53];
katan.castleList[46].castleList = [36, 45];

katan.castleList[47].castleList = [39, 48];
katan.castleList[48].castleList = [47, 49];
katan.castleList[49].castleList = [41, 48, 50];
katan.castleList[50].castleList = [49, 51];
katan.castleList[51].castleList = [43, 50, 52];
katan.castleList[52].castleList = [51, 53];
katan.castleList[53].castleList = [45, 52];
